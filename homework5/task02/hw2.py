...
def my_decorator(original_func):
    def func_which_accept_wrapper(wrapper):
        def func_which_accept_arguments(*args, **kwargs):
            res = wrapper(*args, **kwargs)
            print(res, 1)
            return res

        func_which_accept_arguments.__name__ = original_func.__name__
        func_which_accept_arguments.__doc__ = original_func.__doc__
        func_which_accept_arguments.__original_func = original_func
        return func_which_accept_arguments

    return func_which_accept_wrapper
